...
namespace View4Logs.Theme
{
    ...
    {
        public static readonly ComponentResourceKey AppBarBackground = new ComponentResourceKey(typeof(Brush), nameof(AppBarBackground));
        public static readonly ComponentResourceKey Background = new ComponentResourceKey(typeof(Brush), nameof(Background));
